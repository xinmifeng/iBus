...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
  <tr>
    <td align="center" style=" border-bottom-style:dotted; border-color:#036; border-bottom-width:1"><table width="80%" border="0" cellspacing="2" cellpadding="0">
      <tr>
        <td><img src="images/Portal_0.png" width="209" height="68"></td>
      </tr>
      <tr>
        <td align="right">&gt;&gt;<a href="register.php">现在注册</a> &gt;&gt;<a href="#">忘记密码</a></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td align="center"><table width="80%" border="0" cellpadding="0" cellspacing="2">
        ...
        <tr>
          <td colspan="2" align="center"><input type="button" name="btn_login" id="btn_login" onclick="javascript:login();" value="登录"></td>
        </tr>
