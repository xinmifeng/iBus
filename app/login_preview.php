...
<div class="row pd30 kkk"><a ng-href="register_preview.php"><button type="button" class="btn btn-primary btn-lg btn-block" style="background:#fff; border:1px solid #fff; outline:none; 
