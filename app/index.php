...
<div class="container-fluid pd10">
      <div class="row" style="margin:0 auto;">
        <div class="col-xs-8">
             <a href="#" style="background:#c00;"><img src="images/tiandi.jpg" data-src="holder.js/100%x195" class="img-responsive" width="100%" height="100%"/></a> 
        </div>
          
         <div class="col-xs-4">
             <a href="#" style="background:#c00;"><img src="images/shangwang.jpg" data-src="holder.js/100%x195" class="img-responsive" width="100%" height="100%"/></a> 
...
<div class="container-fluid pd10" >
      <div class="row" style="margin:0 auto;">
        <div class="col-xs-6">
             <a href="#" style="background:#c00;"><img src="images/shipin.jpg"  class="img-responsive" width="100%" height="100%"/></a> 
        </div>
          
<div class="col-xs-6">
             <a href="#" style="background:#c00;"><img src="images/shipin2.jpg"  class="img-responsive" width="100%" height="100%"/></a> 
          </div>
  </div>     
...
<div class="container-fluid pd10">
      <div class="row" style="margin:0 auto;">
        <div class="col-xs-8">
             <a href="#" style="background:#c00;"><img src="images/beauty.jpg"  class="img-responsive" width="100%" height="100%"/></a> 
        </div>
          
         <div class="col-xs-4">
             <a href="#" style="background:#c00;"><img src="images/tree.jpg"  class="img-responsive" width="100%" height="100%"/></a> 
        </div>
  </div>
</div>     
...
<div class="container-fluid pd10">
      <div class="row" style="margin:0 auto;">
        <div class="col-xs-4">
             <a href="#" style="background:#c00;"><img src="images/married.jpg"  class="img-responsive" width="100%" height="100%"/></a> 
        </div>
          
         <div class="col-xs-8">
             <a href="#" style="background:#c00;"><img src="images/qixi.jpg"  class="img-responsive" width="100%" height="100%"/></a> 
        </div>
  </div>
</div>     
...
<div class="container-fluid pd10">
      <div class="row" style="margin:0 auto;">
        <div class="col-xs-8">
             <a href="#" style="background:#c00;"><img src="images/xiecheng.jpg" class="img-responsive" width="100%" height="100%"/></a> 
        </div>
          
     <div class="col-xs-4">
             <a href="#" style="background:#c00;"><img src="images/hospital.jpg" class="img-responsive" width="100%" height="100%"/></a> 
        </div>
  </div>
</div>     
...
<div class="container-fluid pd10" style="margin-bottom:60px;">
      <div class="row" style="margin:0 auto;">
        <div class="col-xs-4">
             <a href="#" style="background:#c00;"><img src="images/movie.jpg"  class="img-responsive" width="100%" height="100%"/></a> 
        </div>
          
         <div class="col-xs-8">
             <a href="#" style="background:#c00;"><img src="images/qianwei.jpg"  class="img-responsive" width="100%" height="100%" /></a> 
        </div>
  </div>
</div>    
...
<div class="navbar navbar-fixed-bottom beau_col" role="navigation" style="padding:0px;">
   <div class="container-fluid" style="margin-top:0px;">
      ...
      <div class="text-center col-xs-1"></div>
         ...
         <div class="text-center col-xs-2 menu">
            <a href="main_mine.html" ><span class="mine" style="margin-bottom:-12px;"></span>我的</a>
         </div>
         <div class="text-center col-xs-1"></div>
      </div>
   </div>
